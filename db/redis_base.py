...
class RedisClient:
    ...
    async def save_user_request(self, user_id, warehouse_ids, supply_types, boxTypeID, coefficient, period, notify, status_request=True):
    ...
    async def stop_user_request(self, user_id: int, timestamp: str):
        try:
